 ...
 * @returns {Promise<any>} The newly created appointment object.
 ...
 *
 * @returns {Promise<any>} The updated appointment details.
 *
 ...
 * @returns {Promise<any>} The appointment document, parsed and stringified.
