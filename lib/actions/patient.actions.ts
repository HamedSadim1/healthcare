 ...
 * @returns {Promise<any>} The newly created user or the existing user if a conflict occurs.
 *
 ...
 * @returns {Promise<any | null>} - A promise that resolves to the patient document if found, or null if no patient is found.
